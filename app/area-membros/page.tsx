...
import { 
  CreditCard, Video, Layout, Mail, LineChart, Users, 
  FileText, Palette, Globe, Shield, PlayCircle, File,
  HelpCircle, BarChart, Tag, Gift,
  Headphones, Search, Smartphone, Code, Share2, Lock,
  Database
} from 'lucide-react';
...
export default function MembersAreaPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Capture leads, crie gatilhos e jornadas de vendas via e-mail, envie campanhas e multiplique suas conversões"
    },
    {
      icon: FileText,
      title: "Questionários",
      description: "Crie questionários e provas e avalie seus alunos, controle o acesso a recursos através de pré-requisitos"
    },
    {
      icon: FileText,
      title: "Certificados",
    ...
    },
    {
      icon: Share2,
      title: "Integrações",
      description: "A Mindz oferece dezenas de integrações com sistemas terceiros como Analytics, Facebook Ads, eNotas, entre outros"
    },
    {
      icon: Lock,
      title: "Plataforma segura",
      description: "A Mindz segue os mais altos níveis de segurança e precaução com seus dados e de seus clientes (LGPD)"
    }
  ];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        >
          <div className="flex items-center gap-8">
            <img 
              src="https://images.unsplash.com/photo-1590650046871-92c887180603?w=500" 
              alt="Mulher gravando um vídeo"
              className="w-64 h-64 object-cover rounded-lg"
            />
            <div>
              <p className="text-sm text-[#9f2dfa] mb-2">www.seudomínio.com.br</p>
              <h2 className="text-2xl font-bold mb-6">Personalização e landing pages</h2>
              <ul className="space-y-3">
        ...
        <motion.div 
          ...
          {...fadeIn}
        >
          <h2 className="text-2xl font-bold mb-6">Crie suas campanhas de e-mail marketing e automações</h2>
          <ul className="space-y-3">
        ...
        >
          <div className="flex items-center gap-8">
            <img 
              ...
              alt="Duas pessoas usando os celulares"
              className="w-64 h-64 object-cover rounded-lg"
            />
            <div>
              <h2 className="text-2xl font-bold mb-6">Tracking de vendas e business inteligence</h2>
              <ul className="space-y-3">
        ...
        <motion.div 
          ...
          {...fadeIn}
        >
          <h2 className="text-2xl font-bold mb-6">Sistema de afiliados</h2>
          <ul className="space-y-3">
        ...
        <motion.div 
          ...
          {...fadeIn}
        >
          <h2 className="text-2xl font-bold mb-8 text-center">5 passos para você vender e lucrar na MINDZ</h2>
          
          <div className="space-y-12">
            <div className="bg-[#2a1b3d] p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">1. Crie sua plataforma grátis, com a sua marca</h3>
              <ul className="space-y-3">
            ...
            <div className="bg-[#2a1b3d] p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">2. Configure seu conteúdo</h3>
              <ul className="space-y-3">
            ...
            <div className="bg-[#2a1b3d] p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">3. Disponibilize suas páginas de venda e customize sua plataforma</h3>
              <ul className="space-y-3">
            ...
            <div className="bg-[#2a1b3d] p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">4. Crie campanhas e automação de e-mail marketing</h3>
              <ul className="space-y-3">
            ...
            <div className="bg-[#2a1b3d] p-8 rounded-lg">
              <h3 className="text-xl font-bold mb-4">5. Analise suas vendas e campanhas</h3>
              <ul className="space-y-3">
        ...
        <motion.div 
          ...
          {...fadeIn}
        >
          <h2 className="text-2xl font-bold mb-4">Automatize suas vendas e fique tranquilo</h2>
          <p className="text-lg mb-8">Lucre muito, suba de nível e ganhe mais benefícios</p>
        </motion.div>
